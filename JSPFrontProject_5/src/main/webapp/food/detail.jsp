	...
	<div class="container">
			...
			<table class="table">
				<tr>
					<td width="40%" class="text-center" rowspan="8"><img
						src="${vo.poster }" style="width: 360px; height: 330px"
				...
				<tr>
					<td colspan="3" class="text-right"><a href="#"
						class="btn btn-xs btn-info">좋아요</a> <a href="#"
						class="btn btn-xs btn-warning">찜하기</a> <a href="#"
						class="btn btn-xs btn-success">예약</a> <a href="list.do"
						class="btn btn-xs btn-danger">목록</a></td>
				</tr>
			</table>
		</div>
		<div class="row text-center" style="margin-top: 10px">
			...
			<script type="text/javascript"
				src="//dapi.kakao.com/v2/maps/sdk.js?appkey=(지도 키 입력)&libraries=services"></script>
			<script>
				// 마커를 담을 배열입니다
				var markers = [];
