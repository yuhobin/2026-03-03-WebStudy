	 ...
	 <section class="archive-area section_padding_80">
                                ...
                                <div class="related-post-slider owl-carousel">
                                    ...
                                    <div class="single-post">
                                        ...
                                        <div class="post-thumb">
                                            <img src="http://menupan.com${img}" alt="">
                                        </div>
                                        <!-- Post Content -->
                             	...
                             	<table class="table">
                             		<tr>
                             			<td width="50%" class="text-center" rowspan="10" valign="middle">
                             				<img src="${vo.poster }" style="width: 100%; height:450px; object-fit:cover"
                             				class="img-rounded"
                             				>
                             			</td>
                             		</tr>
                             	...
                             	<table class="table">
                             		<tr>
                             			<td>
                             				...
                             				<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=(카카오 키 등록)&libraries=services"></script>
											<script>
        ...
        <c:if test="${sessionScope.id!=null }">
        	<form class="review-form">
        		<input type="text" name="msg" placeholder="댓글입력" required>
