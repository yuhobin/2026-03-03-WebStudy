...
| 날짜 | 주요 주제 | 요약 | 상세 내용 |
|:---:|:---|:---|:---:|
| 26.05.06 | <도서관리프로그램 프로젝트 마무리 ERD 제작 및 PPT 제작> | 도서관리프로그램을 완성하고 설계 단계에서 했던 ERD를 수정하고 다시 제작, 마지막으로 제출용 PPT를 제작 | [ppt보러가기](./MiniProject/LibraryKiosk.pdf.md ) [ppt보러가기](./MiniProject/LibraryKiosk.pdf.md ) |
